...
from crump.database import sync_csv_to_db
...
""")
        ...
        # Sync Parquet file
        rows_synced = sync_csv_to_db(parquet_file, job, db_url)
...
""")
        ...
        # First sync
        rows_synced_1 = sync_csv_to_db(parquet_file, job, db_url)
        assert rows_synced_1 == 2

        # Second sync (idempotency test)
        rows_synced_2 = sync_csv_to_db(parquet_file, job, db_url)
...
""")
        ...
        # Sync updated file
        rows_synced_2 = sync_csv_to_db(parquet_file_2, job, db_url)
